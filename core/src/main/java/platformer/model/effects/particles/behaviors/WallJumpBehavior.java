...
public class WallJumpBehavior implements ParticleBehavior {
    ...
    public void init(DustParticle p, Random rand) {
        ...
        p.setXSpeed((rand.nextDouble() * 1.5 + 0.5) * SCALE * -p.getTarget().getFlipSign());
        p.setYSpeed(-(rand.nextDouble() * 1.0 + 0.5) * SCALE);

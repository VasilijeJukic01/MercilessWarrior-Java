...
public class CreditsButton extends AbstractButton {
    ...
    public CreditsButton(int xPos, int yPos, int width, int height, ButtonType buttonType) {
    ...
    protected void loadButtons() {
        images = SpriteManager.getInstance().loadFromSprite(CREDITS_BTN_SHEET, 3, 0, CRE_BTN_SIZE, CRE_BTN_SIZE, 0, SMALL_BTN_W, SMALL_BTN_H);
    }
